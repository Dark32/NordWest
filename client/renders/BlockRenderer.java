...
public class BlockRenderer {
	   ...
	   public void drawFaces(RenderBlocks renderblocks, Block block, int i1, int i2, int i3, int i4, int i5, int i6, boolean solidtop)
	   {
	     ...
	     renderblocks.renderBottomFace(block, 0.0D, 0.0D, 0.0D, renderblocks.getBlockIconFromSide(block, i1));
	     tessellator.draw();
	     if (solidtop) GL11.glDisable(3008);
	     tessellator.startDrawingQuads();
	     tessellator.setNormal(0.0F, 1.0F, 0.0F);
	     renderblocks.renderTopFace(block, 0.0D, 0.0D, 0.0D, renderblocks.getBlockIconFromSide(block, i2));
	     tessellator.draw();
	     if (solidtop) GL11.glEnable(3008);
	     tessellator.startDrawingQuads();
	     tessellator.setNormal(0.0F, 0.0F, 1.0F);
	     renderblocks.renderEastFace(block, 0.0D, 0.0D, 0.0D, renderblocks.getBlockIconFromSide(block, i3));
	     tessellator.draw();
	     tessellator.startDrawingQuads();
	     tessellator.setNormal(0.0F, 0.0F, -1.0F);
	     renderblocks.renderWestFace(block, 0.0D, 0.0D, 0.0D, renderblocks.getBlockIconFromSide(block, i4));
	     tessellator.draw();
	     tessellator.startDrawingQuads();
	     tessellator.setNormal(1.0F, 0.0F, 0.0F);
	     renderblocks.renderNorthFace(block, 0.0D, 0.0D, 0.0D, renderblocks.getBlockIconFromSide(block, i5));
	     tessellator.draw();
	     tessellator.startDrawingQuads();
	     tessellator.setNormal(-1.0F, 0.0F, 0.0F);
	     renderblocks.renderSouthFace(block, 0.0D, 0.0D, 0.0D, renderblocks.getBlockIconFromSide(block, i6));
	     tessellator.draw();
	     GL11.glTranslatef(0.5F, 0.5F, 0.5F);
	   }
}
