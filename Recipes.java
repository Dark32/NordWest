...
public class Recipes {
	public static void init() {
		...
		baseToolRecipe(NWBlock.customTreePlank, Item.swordWood, Item.pickaxeWood, Item.shovelWood, Item.axeWood, Item.hoeWood);
		baseToolRecipe(NWItem.copperIngotItem, NWItem.copperSword, NWItem.copperPickaxe, NWItem.copperShovel, NWItem.copperAxe, NWItem.copperHoe);
		baseToolRecipe(NWItem.mythrilIngotItem, NWItem.mythrilSword, NWItem.mythrilPickaxe, NWItem.mythrilShovel, NWItem.mythrilAxe, NWItem.mythrilHoe);
		
		baseArmorRecipe(NWItem.copperIngotItem, NWItem.copperHelmet, NWItem.copperChestplate, NWItem.copperLegs, NWItem.copperBoots);
		baseArmorRecipe(NWItem.mythrilIngotItem, NWItem.mythrilHelmet, NWItem.mythrilChestplate, NWItem.mythrilLegs, NWItem.mythrilBoots);
		
		addRecipe(new ItemStack(NWBlock.mythrilBlock, 1), new Object[] { "###", "###", "###", '#', NWItem.mythrilIngotItem });
		addRecipe(new ItemStack(NWBlock.copperBlock, 1), new Object[] { "###", "###", "###", '#', NWItem.copperIngotItem });
		
		/** Shapeless recipes **/
		GameRegistry.addShapelessRecipe(new ItemStack(Item.expBottle, 1), NWItem.expaniteItem, Item.glassBottle);
		GameRegistry.addShapelessRecipe(new ItemStack(NWItem.copperIngotItem, 9), new ItemStack(NWBlock.copperBlock));
		GameRegistry.addShapelessRecipe(new ItemStack(NWItem.mythrilIngotItem, 9), new ItemStack(NWBlock.mythrilBlock));
		for (int i = 0; i < 4; i++) {
