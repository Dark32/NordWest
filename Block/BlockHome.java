...
public class BlockHome extends BaseBlock {
	...
	public void registerIcons(IconRegister par1IconRegister) {
		...
		this.iconArray[0] = par1IconRegister.registerIcon("mod_nw:" + this.getUnlocalizedName2() + ".side");
		this.iconArray[1] = par1IconRegister.registerIcon("mod_nw:" + this.getUnlocalizedName2() + ".top");
		this.iconArray[2] = par1IconRegister.registerIcon("mod_nw:" + this.getUnlocalizedName2() + ".buttom");
	...
	private boolean testBlock(World world, int x, int y, int z) {
		...
		if (id != NWBlock.blockhome.blockID) {
			return false;
		} else {
			boolean test = true;
			for (int i = 0; i < 4; i++) {
