...
public class WoolSlabItem extends ItemBlock {
	...
	public WoolSlabItem(int par1) {
		super(par1);
		this.doubleSlab = NWBlock.blockWoolFull1;
		this.theHalfSlab = NWBlock.blockWoolHalf1;
		this.isFullBlock = (par1 == NWBlock.blockWoolHalf1.blockID);
		this.setMaxDamage(0);
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4,
		...
		if (this.isFullBlock) {
			...
			int k1 = j1 & 7;
			boolean flag = (j1 & 16) != 0;

			if ((par7 == 1 && !flag || par7 == 0 && flag) && i1 == this.theHalfSlab.blockID
					&& k1 == par1ItemStack.getItemDamage()) {
				if (par3World.checkIfAABBIsClear(this.doubleSlab.getCollisionBoundingBoxFromPool(par3World, par4, par5,
						par6)) && par3World.setBlock(par4, par5, par6, this.doubleSlab.blockID, k1, 3)) {
	...
	public boolean canPlaceItemBlockOnSide(World par1World, int par2, int par3, int par4, int par5,
		...
		int j2 = i2 & 15;
		boolean flag = (i2 & 16) != 0;

		if ((par5 == 1 && !flag || par5 == 0 && flag) && l1 == this.theHalfSlab.blockID
				&& j2 == par7ItemStack.getItemDamage()) {
			return true;
		} else {
			if (par5 == 0) {
				--par3;
			...
			j2 = i2 & 15;
			flag = (i2 & 16) != 0;
			return l1 == this.theHalfSlab.blockID && j2 == par7ItemStack.getItemDamage() ? true : super
					.canPlaceItemBlockOnSide(par1World, i1, j1, k1, par5, par6EntityPlayer, par7ItemStack);
		}
	}
